...
```
Remove-PrinterDriver [-Name] <String[]> [[-PrinterEnvironment] <String[]>] [-CimSession <CimSession[]>]
...
```
Remove-PrinterDriver [-CimSession <CimSession[]>] [-PassThru] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
