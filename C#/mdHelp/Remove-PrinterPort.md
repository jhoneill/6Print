---
external help file: MSFT_PrinterPort_v6.0.cdxml-help.xml
Module Name:
online version:
schema: 2.0.0
---
...
```
Remove-PrinterPort [-Name] <String[]> [-CimSession <CimSession[]>] [-ComputerName <String>] [-PassThru]
 [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_2
```
Remove-PrinterPort [-CimSession <CimSession[]>] [-PassThru] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
