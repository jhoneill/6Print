...
```
Set-PrintConfiguration [-PrinterName] <String> [-CimSession <CimSession[]>] [-Collate <Boolean>]
 [-Color <Boolean>] [-ComputerName <String>] [-DuplexingMode] [-PaperSize] [-PrintTicketXml <String>]
 [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_2
```
Set-PrintConfiguration [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_3
```
Set-PrintConfiguration [-PrinterObject] <CimInstance> [-CimSession <CimSession[]>] [-Collate <Boolean>]
 [-Color <Boolean>] [-DuplexingMode] [-PaperSize] [-PrintTicketXml <String>] [-ThrottleLimit <Int32>]
