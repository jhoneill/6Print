...
```
Add-PrinterDriver [-Name] <String> [[-InfPath] <String>] [-CimSession <CimSession[]>] [-ComputerName <String>]
 [-PrinterEnvironment <String>] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
